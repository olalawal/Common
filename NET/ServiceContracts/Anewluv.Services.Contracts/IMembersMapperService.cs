...
namespace Anewluv.Services.Contracts
{
    ...
    public interface IMembersMapperService
    {
        ...
        [WebInvoke(UriTemplate = "/getprofiledetails", ResponseFormat = WebMessageFormat.Json, BodyStyle = WebMessageBodyStyle.Bare)]
        Task<FullProfileViewModel> getprofiledetails(ProfileModel model);

        [OperationContract(), FaultContractAttribute(typeof(ServiceFault), Action = "http://Schemas.Testws.Medtox.com")]
        [WebInvoke(UriTemplate = "/getprofilesearchcriteria", ResponseFormat = WebMessageFormat.Json, BodyStyle = WebMessageBodyStyle.Bare)]
        Task<ProfileCriteriaModel> getprofilesearchcriteria(ProfileModel model);
        ...
        Task<SearchResultsViewModel> getmembersearchviewmodels(ProfileModel model);
        ...
        //TO DO might need paging support
        [OperationContract(), FaultContractAttribute(typeof(ServiceFault), Action = "http://Schemas.Testws.Medtox.com")]
        ...
        Task<SearchResultsViewModel> getquickmatches(ProfileModel model);

        //quick search for members in the same country for now, no more filters yet
        //this needs to be updated to search based on the user's prefered setting i.e thier looking for settings
        [OperationContract(), FaultContractAttribute(typeof(ServiceFault), Action = "http://Schemas.Testws.Medtox.com")]
        [WebInvoke(UriTemplate = "/getemailmatches", ResponseFormat = WebMessageFormat.Json, BodyStyle = WebMessageBodyStyle.Bare)]
        Task<SearchResultsViewModel> getemailmatches(ProfileModel model);
        ...
        [OperationContract(), FaultContractAttribute(typeof(ServiceFault), Action = "http://Schemas.Testws.Medtox.com")]
        [WebInvoke(UriTemplate = "/getipquicksearch", ResponseFormat = WebMessageFormat.Json, BodyStyle = WebMessageBodyStyle.Bare)]
        Task<SearchResultsViewModel> getipquicksearch(quicksearchmodel Model);
