...
namespace Anewluv.Services.Contracts
{
    ...
    public interface IGeoService
    {
        ...
        [WebInvoke(UriTemplate = "/getcitystateprovincelbycountrylatlong", ResponseFormat = WebMessageFormat.Json, BodyStyle = WebMessageBodyStyle.Bare)]
        Task<CityList> getcitystateprovincelbycountrylatlong(GeoModel model);
        ...
        [OperationContract(), FaultContractAttribute(typeof(ServiceFault), Action = "http://Schemas.Testws.Medtox.com")]
        [WebInvoke(UriTemplate = "/getgpsdatabycountrycitystateprovince", ResponseFormat = WebMessageFormat.Json, BodyStyle = WebMessageBodyStyle.Bare)]
        Task<gpsdata> getgpsdatabycountrycitystateprovince(GeoModel model);
        ...
        [OperationContract(), FaultContractAttribute(typeof(ServiceFault), Action = "http://Schemas.Testws.Medtox.com")]
        [WebInvoke(UriTemplate = "/getpostalcodebycountrynamecitystateprovince", ResponseFormat = WebMessageFormat.Json, BodyStyle = WebMessageBodyStyle.Bare)]
        Task<postalcode> getpostalcodebycountrynamecitystateprovince(GeoModel model);
